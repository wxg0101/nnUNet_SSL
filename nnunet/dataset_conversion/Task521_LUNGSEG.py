...
if __name__ == '__main__':
    ...
    base = '/media/oem/sda21/wxg/codebase/src_data'
    # this folder should have the training and testing subfolders

    # now start the conversion to nnU-Net:
    task_name = 'Task529_LUNGSegallnotval'
    ...
    # labels
    labels_dir_tr = join(base, 'all_notval', 'mask')
    images_dir_tr = join(base, 'all_notval', 'image')
