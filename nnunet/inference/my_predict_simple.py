...
def main():
    ...
    parser.add_argument("-i", '--input_folder',default='/media/oem/sda21/wxg/codebase/dataset/nnUNet_raw_data_base/nnUNet_raw_data/Task304_SSLSegRandom50/imagesTs', 
                        help="Must contain all modalities for each patient in the correct"
                                                     " order (same as training). Files must be named "
                                                     "CASENAME_XXXX.nii.gz where XXXX is the modality "
                                                     "identifier (0000, 0001, etc)", 
                                                     required=False)
    parser.add_argument('-o', "--output_folder", default='/media/oem/sda21/wxg/codebase/dataset/nnUNet_raw_data_base/nnUNet_raw_data/Task305_SSLSegRandom25/sslout',
                        required=False, 
                        help="folder for saving predictions")
    parser.add_argument('-t', '--task_name', default= '305',help='task name or task ID, required.', required=False)
